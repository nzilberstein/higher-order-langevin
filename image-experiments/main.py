...
def parse_args_and_config():
    ...
    parser.add_argument('--spacing_classes', type=float, default=120, help='Number of noises to skip')
    parser.add_argument('--order_lang', type=str, default='1st', help='Order of Langevin: 1st | 2nd | 3rd')
    ...
    name_folder_results = 'image_samples' + args.order_lang
    os.makedirs(os.path.join(args.exp, name_folder_results), exist_ok=True)
    args.image_folder = os.path.join(args.exp, name_folder_results, args.image_folder)
